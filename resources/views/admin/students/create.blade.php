	...
	<div class="card card-secondary" style="width: 100%;">
		...
		<div class="row">
			<div class="col-sm-12 col-md-8">
				...
				<div class="card">
				    <div class="card-header">
				    	<h3 class="card-title">Novo Estudante</h3>
				    </div>
				    <div class="card-body">
					...
					<div class="form-group row">
                        {!! Form::label('gender','Sexo:') !!}
                            {!! Form::select('gender',array(0=>'Masculino',1=>'Femenino'),null,['class'=>'form-control custom-select']) !!}
                    ...
                    <div class="form-group">
				    {!! Form::label('entry_date','Data de Ingresso:') !!}
