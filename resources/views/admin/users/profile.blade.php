                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
		                    ...
		                    {!! Form::model($user,['method'=>'PATCH','action'=>['App\Http\Controllers\ProfileController@update', $user->id],'id'=>'form','files'=>true]) !!}
                            ...
                            <div class="tab-pane" id="account-security">
                                ...
                                <div class="form-group row">
                                    {!! Form::label('name','Alterar Palavra-passe',['class'=>'col-sm-4 col-form-label font-weight-normal']) !!}
                                    <div class="col-sm-8">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    {!! Form::label('password','Nova Palavra-passe:',['class'=>'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-8">
                                        {!! Form::password('password',['class'=>'form-control' . ( $errors->has('password') ? ' is-invalid' : '' ),'size'=>9]) !!}
                                        @if($errors->has('password'))
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-group row">
                                    {!! Form::label('password','Confirmar Palavra-passe:',['class'=>'col-sm-4 col-form-label']) !!}
                                    <div class="col-sm-8">
                                        {!! Form::password('password',['class'=>'form-control' . ( $errors->has('password') ? ' is-invalid' : '' ),'size'=>9]) !!}
                                        @if($errors->has('password'))
                                            <div class="invalid-feedback">
